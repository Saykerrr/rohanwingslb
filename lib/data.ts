...
export const ACCESSORIES: Accessory[] = [
  ...
  { id:111, name:"Handlebar Grips", cat:"Parts", price:15, desc:"Ergonomic anti-slip grips with shock absorption.", full:"Dual-density rubber construction with a soft outer layer for comfort and firm inner core for control. Honeycomb pattern provides superior grip in wet conditions. Easy installation with standard 22mm inner diameter.", color:"#7F1D1D", colorOptions:[{name:"Black",hex:"#1A1A1A"},{name:"Red",hex:"#DC2626"},{name:"Blue",hex:"#1D4ED8"}] },
