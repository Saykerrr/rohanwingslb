  ...
  return (
    <div>
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "16px 32px" }}>
        <div style={{ height: 16, background: "#F3F4F6", borderRadius: 6, width: 260, animation: "pulse 1.5s ease-in-out infinite" }} />
      </div>
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 32px 64px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48 }} className="prod-grid">
